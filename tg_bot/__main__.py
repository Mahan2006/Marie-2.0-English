...
def main():
    ...
    start_handler = CommandHandler("Khd_start", start, pass_args=True)

    help_handler = CommandHandler("khd_help", get_help)
    help_callback_handler = CallbackQueryHandler(help_button, pattern=r"help_")

    settings_handler = CommandHandler("khd_Settings", get_settings)
    settings_callback_handler = CallbackQueryHandler(settings_button, pattern=r"stngs_")

    donate_handler = CommandHandler("khd_Donate", donate)
